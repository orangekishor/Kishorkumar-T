...
## 👨‍💻 About Me
- Software Developer specializing in **C and C++ programming**
- Working predominantly in **5G Core Technology**, building high-performance and scalable systems
- Passionate about **network protocols, low-level programming, and system optimization**
- Enthusiastic about learning new technologies and contributing to open-source projects

## 🚀 Skills & Expertise
- **Languages:** C, C++
- **Domains:** 5G Core, Telecom Systems, Network Protocols
